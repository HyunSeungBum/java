...
@Component
public class UserCredentialBeans extends UserCredentials {
	
	final private String key = ">ny;GG9`m+?%W}~:"; // 128 bit key
	final private String initVector = "-?C^x3ph.,cGXChK"; // 16 bytes IV
	private IvParameterSpec iv;
	private SecretKeySpec skeySpec;

	@Autowired
	public UserCredentialBeans(@Value("${mongo.userName}") String encryptedUserName,
